...
/**
 The DGCYYLabel class implements a read-only text view.
 ...
 */
@interface DGCYYLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is DGCYYTextVerticalAlignmentCenter.
 */
 ...
 */
@property (nullable, nonatomic, strong) DGCYYTextLayout *textLayout;
 ...
 */
@property (nullable, nonatomic, copy) DGCYYTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) DGCYYTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) DGCYYTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) DGCYYTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `DGCYYTextLayout` class in background thread. Here's an example:
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<DGCYYTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) DGCYYTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) DGCYYTextAction textTapAction;
@property (nullable, nonatomic, copy) DGCYYTextAction textLongPressAction;
@property (nullable, nonatomic, copy) DGCYYTextAction highlightTapAction;
@property (nullable, nonatomic, copy) DGCYYTextAction highlightLongPressAction;
