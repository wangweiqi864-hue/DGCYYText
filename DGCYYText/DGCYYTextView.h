...
/**
 The DGCYYTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for DGCYYTextView objects. 
 ...
 */
@protocol DGCYYTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (void)textView:(DGCYYTextView *)textView willChangeTextLayout:(DGCYYTextLayout *)layout;
- (BOOL)textViewShouldBeginEditing:(DGCYYTextView *)textView;
- (BOOL)textViewShouldEndEditing:(DGCYYTextView *)textView;
- (void)textViewDidBeginEditing:(DGCYYTextView *)textView;
- (void)textViewDidEndEditing:(DGCYYTextView *)textView;
- (BOOL)textView:(DGCYYTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(DGCYYTextView *)textView;
- (void)textViewDidChangeSelection:(DGCYYTextView *)textView;

- (BOOL)textView:(DGCYYTextView *)textView shouldTapHighlight:(DGCYYTextHighlight *)highlight inRange:(NSRange)characterRange;
...
- (BOOL)textView:(DGCYYTextView *)textView shouldLongPressHighlight:(DGCYYTextHighlight *)highlight inRange:(NSRange)characterRange;
...
- (void)textView:(DGCYYTextView *)textView didTapAndSelectTextInRange:(NSRange)range;
- (void)textViewDidLoseSelection:(DGCYYTextView *)textView;
@end
...
/**
 The DGCYYTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+DGCYYText.h for more convenience methods to set the attributes.
 See DGCYYTextAttribute.h and DGCYYTextLayout.h for more information.
 */
@interface DGCYYTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<DGCYYTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is DGCYYTextVerticalAlignmentTop.
 */
@property (nonatomic) DGCYYTextVerticalAlignment textVerticalAlignment;
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and DGCYYTextAttribute.
 See `NSAttributedString+DGCYYText` for more convenience methods to set the attributes.
 */
 ...
 */
@property (nullable, nonatomic, strong, readonly) DGCYYTextLayout *textLayout;
...
/**
 ...
 See `DGCYYTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<DGCYYTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [DGCYYTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, copy) DGCYYTextDebugOption *debugOption;
...
@property (nonatomic) IBInspectable DGCYYTextVerticalAlignment textVerticalAlignment;
...
@property (nullable, nonatomic, copy) NSAttributedString *attributedText;
@property (nullable, nonatomic, strong) id<DGCYYTextParser> textParser;
@property (nullable, nonatomic, strong, readonly) DGCYYTextLayout *textLayout;
@property (nullable, nonatomic, strong) UIFont *placeholderFont;
@property (nullable, nonatomic, copy) NSAttributedString *placeholderAttributedText;
@property (nonatomic) UIEdgeInsets textContainerInset;
...
UIKIT_EXTERN NSString *const DGCYYTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const DGCYYTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const DGCYYTextViewTextDidEndEditingNotification;
