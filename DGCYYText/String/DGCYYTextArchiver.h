 ...
 */
@interface DGCYYTextArchiver : NSKeyedArchiver <NSKeyedArchiverDelegate>
@end
...
/**
 ...
 `DGCYYTextArchiver` or `NSKeyedArchiver`.
 */
@interface DGCYYTextUnarchiver : NSKeyedUnarchiver <NSKeyedUnarchiverDelegate>
@end
