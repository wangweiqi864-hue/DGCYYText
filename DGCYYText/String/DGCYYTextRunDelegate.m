...
static void DeallocCallback(void *ref) {
    DGCYYTextRunDelegate *self = (__bridge_transfer DGCYYTextRunDelegate *)(ref);
    self = nil; // release
}

static CGFloat GetAscentCallback(void *ref) {
    DGCYYTextRunDelegate *self = (__bridge DGCYYTextRunDelegate *)(ref);
    return self.ascent;
}
...
@implementation DGCYYTextRunDelegate
