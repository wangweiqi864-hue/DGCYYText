...
CGAffineTransform DGCYYTextCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]) {
...
CGAffineTransform DGCYYTextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    return DGCYYTextCGAffineTransformGetFromPoints(before, after);
}
...
UIApplication *DGCYYTextSharedApplication(void) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return DGCYYTextIsAppExtension() ? nil : [UIApplication performSelector:@selector(sharedApplication)];
