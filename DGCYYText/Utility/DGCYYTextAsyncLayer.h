...
@class DGCYYTextAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The DGCYYTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface DGCYYTextAsyncLayer : CALayer
...
/**
 The DGCYYTextAsyncLayer's delegate protocol. The delegate of the DGCYYTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol DGCYYTextAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by DGCYYTextAsyncLayer to render the contents in background queue.
 */
@interface DGCYYTextAsyncLayerDisplayTask : NSObject
