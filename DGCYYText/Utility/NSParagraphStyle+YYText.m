...
@interface DGCNSParagraphStyle_DGCYYText : NSObject @end
@implementation DGCNSParagraphStyle_DGCYYText @end


@implementation NSParagraphStyle (DGCYYText)
