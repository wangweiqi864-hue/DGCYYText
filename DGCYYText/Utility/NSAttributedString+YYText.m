//
//  NSAttributedString+DGCYYText.m
...
@interface DGCNSAttributedString_DGCYYText : NSObject @end
@implementation DGCNSAttributedString_DGCYYText @end
...
@implementation NSAttributedString (DGCYYText)

- (NSData *)yy_archiveToData {
    NSData *data = nil;
    @try {
        data = [DGCYYTextArchiver archivedDataWithRootObject:self];
    }
...
+ (instancetype)yy_unarchiveFromData:(NSData *)data {
    ...
    @try {
        one = [DGCYYTextUnarchiver unarchiveObjectWithData:data];
    }
    @catch (NSException *exception) {
        NSLog(@"%@",exception);
    }
...
- (DGCYYTextShadow *)yy_textShadow {
    return [self yy_textShadowAtIndex:0];
}

- (DGCYYTextShadow *)yy_textShadowAtIndex:(NSUInteger)index {
    return [self yy_attribute:DGCYYTextShadowAttributeName atIndex:index];
}

- (DGCYYTextShadow *)yy_textInnerShadow {
    return [self yy_textInnerShadowAtIndex:0];
}

- (DGCYYTextShadow *)yy_textInnerShadowAtIndex:(NSUInteger)index {
    return [self yy_attribute:DGCYYTextInnerShadowAttributeName atIndex:index];
}

- (DGCYYTextDecoration *)yy_textUnderline {
    return [self yy_textUnderlineAtIndex:0];
}

- (DGCYYTextDecoration *)yy_textUnderlineAtIndex:(NSUInteger)index {
    return [self yy_attribute:DGCYYTextUnderlineAttributeName atIndex:index];
}

- (DGCYYTextDecoration *)yy_textStrikethrough {
    return [self yy_textStrikethroughAtIndex:0];
}

- (DGCYYTextDecoration *)yy_textStrikethroughAtIndex:(NSUInteger)index {
    return [self yy_attribute:DGCYYTextStrikethroughAttributeName atIndex:index];
}

- (DGCYYTextBorder *)yy_textBorder {
    return [self yy_textBorderAtIndex:0];
}

- (DGCYYTextBorder *)yy_textBorderAtIndex:(NSUInteger)index {
    return [self yy_attribute:DGCYYTextBorderAttributeName atIndex:index];
}

- (DGCYYTextBorder *)yy_textBackgroundBorder {
    return [self yy_textBackgroundBorderAtIndex:0];
}

- (DGCYYTextBorder *)yy_textBackgroundBorderAtIndex:(NSUInteger)index {
    return [self yy_attribute:DGCYYTextBackedStringAttributeName atIndex:index];
}
...
- (CGAffineTransform)yy_textGlyphTransformAtIndex:(NSUInteger)index {
    NSValue *value = [self yy_attribute:DGCYYTextGlyphTransformAttributeName atIndex:index];
...
- (NSString *)yy_plainTextForRange:(NSRange)range {
    ...
    [self enumerateAttribute:DGCYYTextBackedStringAttributeName inRange:range options:kNilOptions usingBlock:^(id value, NSRange range, BOOL *stop) {
        DGCYYTextBackedString *backed = value;
...
+ (NSMutableAttributedString *)yy_attachmentStringWithContent:(id)content
    ...
    NSMutableAttributedString *atr = [[NSMutableAttributedString alloc] initWithString:DGCYYTextAttachmentToken];
    
    DGCYYTextAttachment *attach = [DGCYYTextAttachment new];
    attach.content = content;
    attach.contentMode = contentMode;
    [atr yy_setTextAttachment:attach range:NSMakeRange(0, atr.length)];
    
    DGCYYTextRunDelegate *delegate = [DGCYYTextRunDelegate new];
...
+ (NSMutableAttributedString *)yy_attachmentStringWithContent:(id)content
                                               ...
                                               attachmentSize:(CGSize)attachmentSize
                                                  alignToFont:(UIFont *)font
                                                    alignment:(DGCYYTextVerticalAlignment)alignment {
    NSMutableAttributedString *atr = [[NSMutableAttributedString alloc] initWithString:DGCYYTextAttachmentToken];
    ...
    switch (alignment) {
        case DGCYYTextVerticalAlignmentTop: {
        ...
        case DGCYYTextVerticalAlignmentCenter: {
        ...
        case DGCYYTextVerticalAlignmentBottom: {
...
+ (NSMutableAttributedString *)yy_attachmentStringWithEmojiImage:(UIImage *)image
    ...
    CGFloat ascent = DGCYYTextEmojiGetAscentWithFontSize(fontSize);
    CGFloat descent = DGCYYTextEmojiGetDescentWithFontSize(fontSize);
    CGRect bounding = DGCYYTextEmojiGetGlyphBoundingRectWithFontSize(fontSize);
    ...
    DGCYYTextAttachment *attachment = [DGCYYTextAttachment new];
    ...
    if (hasAnim) {
        Class imageClass = NSClassFromString(@"DGCYYAnimatedImageView");
...
- (BOOL)yy_canDrawWithUIKit {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [failSet addObject:DGCYYTextShadowAttributeName];
        [failSet addObject:DGCYYTextInnerShadowAttributeName];
        [failSet addObject:DGCYYTextUnderlineAttributeName];
        [failSet addObject:DGCYYTextStrikethroughAttributeName];
        [failSet addObject:DGCYYTextBorderAttributeName];
        [failSet addObject:DGCYYTextBackgroundBorderAttributeName];
        [failSet addObject:DGCYYTextBlockBorderAttributeName];
        [failSet addObject:DGCYYTextAttachmentAttributeName];
        [failSet addObject:DGCYYTextHighlightAttributeName];
        [failSet addObject:DGCYYTextGlyphTransformAttributeName];
    });
...
@implementation NSMutableAttributedString (DGCYYText)
...
- (void)yy_setTextBackedString:(DGCYYTextBackedString *)textBackedString range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextBackedStringAttributeName value:textBackedString range:range];
}

- (void)yy_setTextBinding:(DGCYYTextBinding *)textBinding range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextBindingAttributeName value:textBinding range:range];
}

- (void)yy_setTextShadow:(DGCYYTextShadow *)textShadow range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextShadowAttributeName value:textShadow range:range];
}

- (void)yy_setTextInnerShadow:(DGCYYTextShadow *)textInnerShadow range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextInnerShadowAttributeName value:textInnerShadow range:range];
}

- (void)yy_setTextUnderline:(DGCYYTextDecoration *)textUnderline range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextUnderlineAttributeName value:textUnderline range:range];
}

- (void)yy_setTextStrikethrough:(DGCYYTextDecoration *)textStrikethrough range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextStrikethroughAttributeName value:textStrikethrough range:range];
}

- (void)yy_setTextBorder:(DGCYYTextBorder *)textBorder range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextBorderAttributeName value:textBorder range:range];
}

- (void)yy_setTextBackgroundBorder:(DGCYYTextBorder *)textBackgroundBorder range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextBackgroundBorderAttributeName value:textBackgroundBorder range:range];
}

- (void)yy_setTextAttachment:(DGCYYTextAttachment *)textAttachment range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextAttachmentAttributeName value:textAttachment range:range];
}

- (void)yy_setTextHighlight:(DGCYYTextHighlight *)textHighlight range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextHighlightAttributeName value:textHighlight range:range];
}

- (void)yy_setTextBlockBorder:(DGCYYTextBorder *)textBlockBorder range:(NSRange)range {
    [self yy_setAttribute:DGCYYTextBlockBorderAttributeName value:textBlockBorder range:range];
}

- (void)yy_setTextRubyAnnotation:(DGCYYTextRubyAnnotation *)ruby range:(NSRange)range {
...
- (void)yy_setTextGlyphTransform:(CGAffineTransform)textGlyphTransform range:(NSRange)range {
    ...
    [self yy_setAttribute:DGCYYTextGlyphTransformAttributeName value:value range:range];
}
...
- (void)yy_setTextHighlightRange:(NSRange)range
                 ...
                 backgroundColor:(UIColor *)backgroundColor
                       ...
                       tapAction:(DGCYYTextAction)tapAction
                 longPressAction:(DGCYYTextAction)longPressAction {
    DGCYYTextHighlight *highlight = [DGCYYTextHighlight highlightWithBackgroundColor:backgroundColor];
...
+ (NSArray *)yy_allDiscontinuousAttributeKeys {
    ...
    dispatch_once(&onceToken, ^{
        keys = @[(id)kCTSuperscriptAttributeName,
                 ...
                 DGCYYTextBackedStringAttributeName,
                 DGCYYTextBindingAttributeName,
                 DGCYYTextAttachmentAttributeName].mutableCopy;
