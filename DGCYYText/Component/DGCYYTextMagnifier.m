...
@interface _DGCYYTextMagnifierCaret : DGCYYTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _DGCYYTextMagnifierCaret
...
- (DGCYYTextMagnifierType)type {
    return DGCYYTextMagnifierTypeCaret;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(DGCYYTextCGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, DGCYYTextCGFloatFromPixel(1));
...
@interface _DGCYYTextMagnifierRanged : DGCYYTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _DGCYYTextMagnifierRanged
#define kMultiple 1.2
#define kSize CGSizeMake(141, 60)
#define kPadding DGCYYTextCGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
- (DGCYYTextMagnifierType)type {
    return DGCYYTextMagnifierTypeRanged;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, DGCYYTextCGFloatPixelFloor(kPadding) + kHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, DGCYYTextCGFloatPixelFloor(kPadding) + kHeight);
...
@implementation DGCYYTextMagnifier

+ (id)magnifierWithType:(DGCYYTextMagnifierType)type {
    switch (type) {
        case DGCYYTextMagnifierTypeCaret :return [_DGCYYTextMagnifierCaret new];
        case DGCYYTextMagnifierTypeRanged :return [_DGCYYTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[DGCYYTextMagnifier class]]) {
