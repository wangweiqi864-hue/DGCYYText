...
@class DGCYYTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The DGCYYTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol DGCYYTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable DGCYYTextDebugOption *)option;
@end



/**
 The debug option for DGCYYText.
 */
@interface DGCYYTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (nullable DGCYYTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable DGCYYTextDebugOption *)option;
