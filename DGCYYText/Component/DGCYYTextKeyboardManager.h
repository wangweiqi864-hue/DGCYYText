...
/**
 ...
 Use -[DGCYYTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} DGCYYTextKeyboardTransition;


/**
 The DGCYYTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol DGCYYTextKeyboardObserver <NSObject>
@optional
...
/**
 A DGCYYTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface DGCYYTextKeyboardManager : NSObject
