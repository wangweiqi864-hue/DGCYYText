...
/**
 A simple view to diaplay `DGCYYTextLayout`.
 ...
 */
@interface DGCYYTextContainerView : UIView
...
@property (nullable, nonatomic, strong) DGCYYTextLayout *layout;
...
- (void)setLayout:(nullable DGCYYTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration;
