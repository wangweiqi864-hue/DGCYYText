...
@protocol DGCYYTextLinePositionModifier;
 ...
 */
extern const CGSize DGCYYTextContainerMaxSize;

/**
 The DGCYYTextContainer class defines a region in which text is laid out.
 DGCYYTextLayout class uses one or more DGCYYTextContainer objects to generate layouts.
 
 A DGCYYTextContainer defines rectangular regions (`size` and `insets`) or 
 ...
 Example:
     ...
     └─────────────────────────────┘
 */
@interface DGCYYTextContainer : NSObject <NSCoding, NSCopying>
...
/// The constrained size. (if the size is larger than DGCYYTextContainerMaxSize, it will be clipped)
...
@property DGCYYTextTruncationType truncationType;
...
@property (nullable, copy) id<DGCYYTextLinePositionModifier> linePositionModifier;
@end


/**
 The DGCYYTextLinePositionModifier protocol declares the required method to modify
 the line position in text layout progress. See `DGCYYTextLinePositionSimpleModifier` for example.
 */
@protocol DGCYYTextLinePositionModifier <NSObject, NSCopying>
@required
/**
 This method will called before layout is completed. The method should be thread-safe.
 @param lines     An array of DGCYYTextLine.
 @param text      The full text.
 @param container The layout container.
 */
- (void)modifyLines:(NSArray<DGCYYTextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(DGCYYTextContainer *)container;
@end


/**
 A simple implementation of `DGCYYTextLinePositionModifier`. It can fix each line's position
 to a specified value, lets each line of height be the same.
 */
@interface DGCYYTextLinePositionSimpleModifier : NSObject <DGCYYTextLinePositionModifier>
...
/**
 DGCYYTextLayout class is a readonly class stores text layout result.
 ...
 example: (layout with a circle exclusion path)
     ...
     └──────────────────────────┘
 */
@interface DGCYYTextLayout : NSObject <NSCoding>
...
*/
+ (nullable DGCYYTextLayout *)layoutWithContainerSize:(CGSize)size text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable DGCYYTextLayout *)layoutWithContainer:(DGCYYTextContainer *)container text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable DGCYYTextLayout *)layoutWithContainer:(DGCYYTextContainer *)container text:(NSAttributedString *)text range:(NSRange)range;

/**
 Generate layouts with the given containers and text.
 
 @param containers An array of DGCYYTextContainer object (if nil, returns nil).
 @param text       The text (if nil, returns nil).
 @return An array of DGCYYTextLayout object (the count is same as containers),
    or nil when an error occurs.
 */
+ (nullable NSArray<DGCYYTextLayout *> *)layoutWithContainers:(NSArray<DGCYYTextContainer *> *)containers
...
///< The text container
@property (nonatomic, strong, readonly) DGCYYTextContainer *container;
///< The full text
...
///< Array of `DGCYYTextLine`, no truncated
@property (nonatomic, strong, readonly) NSArray<DGCYYTextLine *> *lines;
///< DGCYYTextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) DGCYYTextLine *truncatedLine;
///< Array of `DGCYYTextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<DGCYYTextAttachment *> *attachments;
 ...
 */
- (nullable DGCYYTextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable DGCYYTextPosition *)positionForPoint:(CGPoint)point
 ...
 */
- (nullable DGCYYTextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable DGCYYTextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable DGCYYTextRange *)textRangeByExtendingPosition:(DGCYYTextPosition *)position;
...
/**
 ...
 @return An array of `DGCYYTextSelectionRect` objects that encompass the selection.
 If not found, the array is empty.
 */
- (NSArray<DGCYYTextSelectionRect *> *)selectionRectsForRange:(DGCYYTextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<DGCYYTextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(DGCYYTextRange *)range;
...
/**
 ...
 @param range An object representing a range in text.
 @return An array of `DGCYYTextSelectionRect` objects contains the start and end to
 the selection. If not found, the array is empty.
 */
- (NSArray<DGCYYTextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(DGCYYTextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable DGCYYTextDebugOption *)debug
