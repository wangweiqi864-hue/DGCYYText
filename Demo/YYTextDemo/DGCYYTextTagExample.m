...
#import "DGCYYTextTagExample.h"
#import "DGCYYText.h"
#import "UIView+YYAdd.h"
#import "DGCYYTextExampleHelper.h"

@interface DGCYYTextTagExample () <DGCYYTextViewDelegate>
@property (nonatomic, assign) DGCYYTextView *textView;
@end

@implementation DGCYYTextTagExample
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < tags.count; i++) {
        ...
        [tagText yy_setTextBinding:[DGCYYTextBinding bindingWithDeleteConfirm:NO] range:tagText.yy_rangeOfAll];
