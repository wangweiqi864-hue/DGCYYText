 ...
 */
@interface DGCYYGestureRecognizer : UIGestureRecognizer
...
@property (nonatomic, copy) void (^action)(DGCYYGestureRecognizer *gesture, YYGestureRecognizerState state);
