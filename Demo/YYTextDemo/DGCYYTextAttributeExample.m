...
#import "DGCYYTextAttributeExample.h"
#import "DGCYYText.h"
...
@implementation DGCYYTextAttributeExample
...
- (void)viewDidLoad {
    ...
    
    {
        ...
        DGCYYTextShadow *shadow = [DGCYYTextShadow new];
    ...
    
    {
        ...
        shadow.offset = CGSizeMake(0, -1);
        shadow.radius = 1.5;
        DGCYYTextShadow *subShadow = [DGCYYTextShadow new];
        ...
        DGCYYTextShadow *innerShadow = [DGCYYTextShadow new];
    ...
    
    {
        ...
        border.lineStyle = DGCYYTextLineStylePatternCircleDot;
    ...
    
    {
        ...
        border.lineStyle = DGCYYTextLineStyleSingle;
        one.yy_textBackgroundBorder = border;
        
        DGCYYTextBorder *highlightBorder = border.copy;
