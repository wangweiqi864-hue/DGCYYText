...
/**
 ...
 Sample Code:
     ...
     DGCYYFrameImage *image = [DGCYYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     DGCYYAnimatedImageView *imageView = [DGCYYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface DGCYYFrameImage : UIImage <YYAnimatedImage>
...
/**
 ...
 @return An initialized DGCYYFrameImage object, or nil when an error occurs.
 */
