 ...
 */
@interface DGCYYImageFrame : NSObject <NSCopying>
...
/**
 ...
 Example:
    ...
    DGCYYImageDecoder *decoder = [DGCYYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    DGCYYImageDecoder *decoder = [[DGCYYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface DGCYYImageDecoder : NSObject
 ...
 */
- (nullable DGCYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 Example:
    ...
    DGCYYImageEncoder *jpegEncoder = [[DGCYYImageEncoder alloc] initWithType:YYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    DGCYYImageEncoder *gifEncoder = [[DGCYYImageEncoder alloc] initWithType:YYImageTypeGIF];
 ...
 */
@interface DGCYYImageEncoder : NSObject
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(DGCYYImageDecoder *)decoder type:(YYImageType)type quality:(CGFloat)quality;
...
/**
 Whether WebP is available in DGCYYImage.
 */
