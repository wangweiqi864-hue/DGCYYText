...
/**
 ...
 The animation can be played by DGCYYAnimatedImageView.
 ...
 Sample Code:
    ...
    DGCYYSpriteSheetImage *sprite;
    sprite = [[DGCYYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    DGCYYAnimatedImageView *imgView = [DGCYYAnimatedImageView new];
